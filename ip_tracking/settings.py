...
SECRET_KEY = 'django-insecure--37*axh6yrg)umkx7o#2mrra^yu8r$5+t#ll00f()#%0$k_##h'
...
RATELIMIT_VIEW = 'ip_tracking.views.rate_limit_exceeded_view'  # optional custom handler
...
if CELERY_TASK_ALWAYS_EAGER:
    # Run tasks locally and skip broker
    CELERY_BROKER_URL = None
    CELERY_RESULT_BACKEND = None
else:
    # Use Redis or your configured broker
